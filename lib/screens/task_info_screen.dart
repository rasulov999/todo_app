...
class _TaskInfoScreenState extends State<TaskInfoScreen> {
        ...
        body: Container(
          ...
          child: Column(
            ...
            children: [
                    ...
                    children: [
                      Container(
                        ...
                        decoration: BoxDecoration(
                          ...
                          border:
                              Border.all(color: MyColors.white, width: 1.5.w),
                        ),
                      ),
                      Padding(
                        padding: const EdgeInsets.only(left: 20, right: 100).r,
                        child: Text(
                          widget.model!.title,
                          style: TextStyle(
              ...
              Padding(
                padding: EdgeInsets.only(left: 36, top: 15, bottom: 38).r,
                child: Text(
  ...
  Widget deleteTask() {
    return Container(
      padding: EdgeInsets.only(left: 8, right: 8, top: 10, bottom: 4).r,
      width: 500.w,
      height: 200.h,
      decoration: BoxDecoration(
        color: MyColors.C_363636,
